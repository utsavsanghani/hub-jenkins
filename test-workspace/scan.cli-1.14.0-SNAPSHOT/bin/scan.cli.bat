...
@rem ##########################################################################
@rem
@rem  scan.cli startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\scan.cli-1.14.0-SNAPSHOT-standalone.jar

@rem Execute scan.cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SCAN_CLI_OPTS%  -Done-jar.silent=true -jar "%CLASSPATH%"  %CMD_LINE_ARGS%
